...
import VoiceAssistantTester from "@/features/simulator-studio/components/VoiceAssistantTester";
...
const VoiceAssistantTesterPage = () => {
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          <div>
            ...
            <p className="mt-2 md:mt-4 text-base md:text-lg text-slate-300 max-w-3xl">
              Test how voice assistants recognize commands under different conditions. Adjust context depth and error modes.
            </p>
          </div>
          <Button 
            variant="outline" 
...
export default VoiceAssistantTesterPage;
