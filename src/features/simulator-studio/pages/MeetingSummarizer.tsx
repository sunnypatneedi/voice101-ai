...
import MeetingSummarizerSimulator from "@/features/simulator-studio/components/MeetingSummarizerSimulator";
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          <div>
            ...
            <p className="mt-2 md:mt-4 text-base md:text-lg text-slate-300 max-w-3xl">
              Upload or paste meeting transcripts and generate concise AI summaries with key points and action items.
            </p>
          </div>
          <Button 
            variant="outline" 
