...
import StoryVoiceSimulator from "@/features/simulator-studio/components/StoryVoiceSimulator";
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          <div>
            ...
            <p className="mt-2 md:mt-4 text-base md:text-lg text-slate-300 max-w-3xl">
              Generate compelling AI-narrated stories with customizable templates, voices, and sound effects.
            </p>
          </div>
          <Button 
            variant="outline" 
...
export default StoryVoiceMaker;
